  ...
  return (
    ...
    >
      ...
      <div className={`fixed bottom-6 right-6 z-50 transform transition-all duration-500 delay-1000 ${
        ...
        <button className="bg-linear-to-r from-[#E3003A] to-[#0096D6] text-white px-6 py-3 rounded-full font-bold shadow-2xl transform transition-all duration-300 hover:scale-110 hover:shadow-3xl active:scale-95 group">
          Contact Us
